  ...
  module Services
    module Rabbit
      class RabbitError < VCAP::Services::Base::Error::ServiceError
        ...
        RABBIT_GET_PERMISSION_FAILED   = [31313, HTTP_INTERNAL, "Could not get user %s permission"]
        RABBIT_SET_PERMISSION_FAILED   = [31314, HTTP_INTERNAL, "Could not set user %s permission to %s"]
        RABBIT_LIST_USERS_FAILED       = [31315, HTTP_INTERNAL, "Could not list users"]
