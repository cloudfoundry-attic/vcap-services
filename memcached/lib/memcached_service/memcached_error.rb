...
class VCAP::Services::Memcached::MemcachedError < VCAP::Services::Base::Error::ServiceError
  ...
  MEMCACHED_CONNECT_INSTANCE_FAILED     = [31205, HTTP_INTERNAL, "Could not connect memcached instance: %s"]
  ...
  MEMCACHED_INVALID_PLAN                = [31208, HTTP_INTERNAL, 'Invalid plan %s.']
end
